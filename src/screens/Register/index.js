...
export default class Register extends React.Component {
  ...
  render() {
    let { firstName, lastName, email, password, err } = this.state;
    return (
      //   ------Background image------
      <ImageBackground
      ...
      >
        ...
        <View style={styles._inner_layer}>
          {/*   ------Text------  */}
          <Text style={styles._label}>Lets Get Started!</Text>
          {/*   ------FirstName Input------  */}
          <TextInput
            ...
            value={firstName}
            onChangeText={(e) => this.setState({ firstName: e, err: "" })}
          />
          ...
          <TextInput
            ...
            value={lastName}
            onChangeText={(e) => this.setState({ lastName: e, err: "" })}
          />
          <Text style={styles._err}>{this.state.err}</Text>
          {/*   ------Email Input------  */}
          <TextInput
